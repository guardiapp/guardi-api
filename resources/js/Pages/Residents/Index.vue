<template>
    <MainLayout>
        <div class="container px-6 mx-auto grid">
            ...
            <div v-if="residents">
                <TableTemplate
                    :columns="user.type === 'Admin' ? ['', 'Nombre', 'Residencia', 'Torre', 'Apartamento', 'Acciones'] : ['', 'Nombre', 'Torre', 'Apartamento', 'Acciones']"
                ...
                >
                    ...
                    <template #column-actions="{ row }">
                        <div class="flex items-center space-x-4 text-sm">
                            ...
                            <button
                                @click="deleteResident(row.actions.id)"
                                class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 rounded-lg focus:outline-none focus:shadow-outline-gray"
                                :class="
                                    themeStore.dark
                                        ? 'text-gray-400'
...
const deleteResident = (id) => {
    Swal.fire({
        ...
        text: "¿Desea eliminar este residente?",
        icon: "warning",
                    ...
                    notify(
                        {
                            ...
                            text: "El residente ha sido eliminado",
                        },
                        4000
                    );
                },
