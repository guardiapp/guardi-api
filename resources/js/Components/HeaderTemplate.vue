<template>
    <header class="z-10 py-4 shadow-md" :class="{
        'bg-white': !themeStore.dark,
        'bg-gray-800': themeStore.dark,
    }">
        <div class="container flex items-center justify-between h-full px-6 mx-auto" :class="{
            'text-purple-600': !themeStore.dark,
            'text-purple-300': themeStore.dark,
        }">
            <!-- Mobile hamburger -->
            <button class="p-1 mr-5 -ml-1 rounded-md md:hidden focus:outline-none focus:shadow-outline-purple"
                @click="themeStore.toggleSideMenu" aria-label="Menu">
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
                <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                    ...
                    <input class="w-full pl-8 pr-2 text-sm border-0 rounded-md form-input" :class="{
            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <li class="flex">
                    <button class="rounded-md focus:outline-none focus:shadow-outline-purple"
                        @click="themeStore.toggleTheme" aria-label="Toggle color mode">
                        <template v-if="!themeStore.dark">
                ...
                <li class="relative">
                    <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple"
                        ...
                        <span aria-hidden="true"
                            ...
                            :class="{
                                'border:white': !themeStore.dark,
                                'border-gray-800': themeStore.dark,
                            }"></span>
                    </button>
                    <template v-if="themeStore.isNotificationsMenuOpen">
                        <ul transition:leave="transition ease-in duration-150" transition:leave-start="opacity-100"
                            ...
                            class="absolute right-0 w-56 p-2 mt-2 space-y-2 border rounded-md shadow-md" :class="{
                                ...
                                'text-gray-300 border-gray-700 bg-gray-700': themeStore.dark,
                            }">
                            <li class="flex">
                                <a class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md"
                                    ...
                                    <span
                                        ...
                                        :class="{
                                            'text-red-600 bg-red-100': !themeStore.dark,
                                            'text-red-100 bg-red-600': themeStore.dark,
                                        }">
                                        13
                                    </span>
                                </a>
